...
def dataset(name = "ItalyPowerDemand", type = "variable_p", aux_feat_prob = 0.5, use_cuda = False, seed = 2022):
    ...
    if name == "ItalyPowerDemand":
        # Data description
        # Path to data
        data_path_train = "/Data/ItalyPowerDemand_TRAIN.txt"
        data_path_test = "/Data/ItalyPowerDemand_TEST.txt"
        n_feat = 24
        n_aux_feat = 12
        ...
        return n_base_feat, n_aux_feat,  X_base, X_aux, X_aux_new, aux_mask,X, Y, label


    if name == "HIGGS":
        # Data description
        # Path to data
        data_path = "/Data/HIGGS_1M.csv.gz"
        n_feat = 21
        n_aux_feat = 16
        n_base_feat = n_feat - n_aux_feat
        ...
        if type == "variable_p":
                ...
                mask_path = os.path.join("Data", mask_file_name)
    ...
    if name == "svmguide3":
        # Data description
        # Path to data
        data_path = os.path.join("/Data/svmguide3.txt")
        n_feat = 21
        n_aux_feat = 19
        n_base_feat = n_feat - n_aux_feat
